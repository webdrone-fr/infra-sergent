            ...
            case "update-modules":
                ...
                if (resultGitpull.contains("output")){
                    try {
                        ...
                        result = execute("docker", ("exec "+ stackName +"-meveo curl -H 'Content-Type: application/json; charset=UTF-8' --max-time "+ timeoutSec +" -X POST localhost:8080/meveo/api/rest/module/initDefault -d params=" + params).split("\\s+") );
