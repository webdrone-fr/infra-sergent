            ...
            case "update-modules":
                ...
                if (resultGitpull.contains("output")){
                    try {
                        ...
                        result = execute("docker", ("exec -t "+ stackName +"-meveo curl -X POST -H 'Content-Type:application/json' -u " + username + ":" + password + " --max-time "+ timeoutSec +" --data-raw '" + params + "' localhost:8080/meveo/api/rest/module/initDefault").split("\\s+"));
